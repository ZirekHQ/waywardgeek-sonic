...
sonic_unit_test: tests/runtests.c tests/sonic_api_test.c tests/input_clamping_test.c tests/wave_channel_validation_test.c tests/chord_pitch_test.c tests/genwave.c sonic.c sonic.h wave.c wave.h tests/tests.h tests/genwave.h
	$(CC) $(CFLAGS) -I. -o sonic_unit_test tests/runtests.c tests/sonic_api_test.c tests/input_clamping_test.c tests/wave_channel_validation_test.c tests/chord_pitch_test.c tests/genwave.c sonic.c wave.c -lm

coverage:
	$(CC) $(CFLAGS) -I. -fprofile-arcs -ftest-coverage -o sonic_coverage tests/runtests.c tests/sonic_api_test.c tests/input_clamping_test.c tests/wave_channel_validation_test.c tests/chord_pitch_test.c tests/genwave.c sonic.c wave.c -lm
	./sonic_coverage
